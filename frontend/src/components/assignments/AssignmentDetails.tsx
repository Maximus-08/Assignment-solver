              ...
              <div className="mt-2 space-y-2">
                ...
                {assignment.course_name && (
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-900">{assignment.course_name}</span>
                  </div>
                )}
                {assignment.instructor && (
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-900">{assignment.instructor}</span>
                  </div>
                )}
                <div className="flex items-center">
                  <svg className="h-4 w-4 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm text-gray-900 capitalize">{assignment.assignment_type?.replace('_', ' ') || 'Assignment'}</span>
                </div>
              </div>
            </div>
          </div>
